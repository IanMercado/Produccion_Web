...
<body>
    <div id="portada">
        <class="d-block auto img-fluid pb-3 pt-5">
    </div>
    ...
    <div class=row>
        ...
        <div class=col-6>
                    <form action="">
                        <td width="150"><a target="_blank" href="./PDF-Producto/pdf.php?id_producto=<?php echo  $pr_id; ?>" class="btn btn-danger">Descargar ficha en PDF</a></td>
                    </form>
        </div>
    </div>
